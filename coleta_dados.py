...
# Teste focado exclusivamente no Nikolas Ferreira (ID correto)
...
def executar_pipeline():
    ...
    try:
        ...
        # 3. Buscar despesas na API da Câmara (sem amarras de ano)
        ...
        # 4. Inserir as despesas imprimindo erros caso ocorram
