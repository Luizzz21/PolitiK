...
# ID do deputado (Ex: 204534 é a Tabata Amaral, apenas como exemplo para teste)
# Você pode encontrar os IDs na rota /deputados da API
DEPUTADO_ID = "204534" 
ANO = "2026"

# URL da API para despesas de um deputado específico em um ano
...
try:
        # Fazendo a requisição HTTP (sem precisar de requests para manter simples)
            req = urllib.request.Request(url, headers={'Accept': 'application/json'})
                with urllib.request.urlopen(req) as response:
                            dados_brutos = json.loads(response.read().decode('utf-8'))
                                    despesas = dados_brutos.get('dados', [])
                                            
                                                # Processando os dados: agrupando gastos por tipo
                                                    gastos_agrupados = {}
                                                        total_gasto = 0
                                                                ...
                                                                for despesa in despesas:
                                                                            tipo = despesa['tipoDespesa']
                                                                                    valor = float(despesa['valorDocumento'])
                                                                                                    ...
                                                                                                    # Se o tipo já existe, soma; se não, cria.
                                                                                                                            ...
                                                                                                                            gastos_agrupados[tipo] += valor
                                                                                                                                                    ...
                                                                                                                                                    gastos_agrupados[tipo] = valor
                                                                                                                                                                        ...
                                                                                                                                                                        total_gasto += valor
                                                                                                                                                                            ...
                                                                                                                                                                            # Criando o formato final para o Frontend ler facilmente
                                                                                                                                                                                dados_processados = {
                                                                                                                                                                                    ...
                                                                                                                                                                                    # Garantindo que a pasta onde salvaremos o arquivo existe (útil para o GitHub Actions)
