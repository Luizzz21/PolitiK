...
const DashboardApp = (function() {
    ...
    return {
        ...
        openExpressModal: function() { document.getElementById('dash-express-modal').classList.add('active'); },
        closeExpressModal: function() { document.getElementById('dash-express-modal').classList.remove('active'); },
        ...
        openLoginModal: function() { document.getElementById('dash-login-modal').classList.add('active'); },
        closeLoginModal: function() { document.getElementById('dash-login-modal').classList.remove('active'); },

        submitExpressAuth: async function() {
            const nome = document.getElementById('express-nome').value;
            const email = document.getElementById('express-email').value;
            const pass = document.getElementById('express-password').value;
            const errDiv = document.getElementById('dash-express-error');
            ...
            try {
                ...
                if (data.success) {
                    ...
                    errDiv.textContent = data.message || data.error || 'Não foi possível validar seus dados.';
